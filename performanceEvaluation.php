                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="section-tittle section-tittle3">
                                <div class="front-text">
                                    <h2 class="">PROJECT EVALUATION</h2>
                                </div>
    ...
    $totalAccidentCost = $totalAccidentCost + $accidentCost;
                ...
                echo " <div class='col-12'>";
                        ...
                        echo " <div class='tab-content active' id='nav-tabContent'>";
                            ...
                            echo "                <p>This is the total expense of all the labor work for this project. For More Detail report.</p>";
                            ...
                            echo "         <div class='col-lg-4 col-md-6'>";
                            echo "             <div class='single-project mb-30'>";
                            echo "                <p>This is the total expense of all the resources ordered for this project. For More Detail report.</p>";
                            ...
                            echo "      <div class='col-lg-4 col-md-6'>";
                            echo "          <div class='single-project mb-30'>";
                            echo "                <p>This is the total expense of all the accidents for this project. For More Detail report.</p>";
