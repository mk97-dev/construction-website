                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="section-tittle section-tittle3">
                                <div class="front-text">
                                    <h2 class="">SCHEDULE DETAIL</h2>
                                </div>
                                <div class="col-xl-2 col-lg-2 col-md-3" id = "newProjectBtn">
                                <div class="header-right-btn f-right d-none d-lg-block">
                                    <a href="newSchedule.php" class="btn">New Schedule</a>
                                </div>
                            </div>
                            </div>
                                ...
                                <div class="tab-content active" id="nav-tabContent">
                                    ...
                                    <div class="tab-pane fade active show" id="nav-home" role="tabpanel" aria-labelledby="nav-home-tab">           
                                        <div class="project-caption">
                                            <div class="row">
                                                <?php $db = mysqli_connect("localhost","root","","construction");
...
if(isset($_POST['submit']))
			{  
                                                ...
                                                echo "</script>";
                                                $res = mysqli_query($db,"SELECT * FROM `schedule` where `projectName`='$projectName';");
                                                        ...
                                                        elseif($time == "NULL"){
                                                          $res = mysqli_query($db,"SELECT * FROM `resourcesDaily` where `date` = 'NULL' AND `projectName`='$projectName';");
                                                        } */
                                                        ...
                                                        echo "<h2 > SCHEDULE DETAIL OF '$projectName'</h2>";
                                                        ...
                                                        while ($row = mysqli_fetch_assoc($res)){
                                                            ...
                                                            $endDate = $row['endDate'];
                                                            $diff = (new DateTime(date("Y/m/d")))->diff(new DateTime($endDate))->format("%r%a");
                                                            echo "<tr >";
                                                            echo"<td>";echo$row['workName'];echo"</td>";
                                                            echo"<td>";echo$row['startDate'];echo"</td>";
                                                            echo"<td>";echo$row['endDate'];echo"</td>";
                                                            echo"<td>";echo$diff;echo"</td>";
                                                            echo"<td>";echo$status;echo "<form action='changeStatus.php' class='changeStatusForm' method = 'post' name = 'changeStatus' enctype='multipart/form-data'>
                                                                                        <input type='hidden' name = 'workName' value = '$workName'>
                                                                                        <input type='hidden' name = 'status' value = '$status'>
                                                                                        <input type='submit' id='changeStatusBtn' name='changeStatus' value = 'Change Status'> </form>";
                                                            /*echo "<label>Not Completed
