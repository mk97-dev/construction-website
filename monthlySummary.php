...
if(isset($_POST['submit'])){
    ...
    $duration = "Monthly";
    $laborDuesQuery = mysqli_query($db,"SELECT * FROM `dailyreport` WHERE projectName = '$projectName' AND `Date` >= CURRENT_DATE- INTERVAL 30 DAY;");
 ...
 $resourcesCostQuery = mysqli_query($db,"SELECT * FROM `resourcesdaily` WHERE projectName = '$projectName' AND `date` >= CURRENT_DATE- INTERVAL 30 DAY;");
 ...
 $AccidentsCostQuery = mysqli_query($db,"SELECT * FROM `accidents` WHERE projectName = '$projectName' AND `date` >= CURRENT_DATE- INTERVAL 30 DAY;");
    ...
    $totalAccidentCost = $totalAccidentCost + $accidentCost;
                ...
                echo " <div class='col-12'>";
                        ...
                        echo " <div class='tab-content active' id='nav-tabContent'>";
                            ...
                            echo "                <p>This is the total expense of all the labor work for the past 30 days. For More Detail report.</p>";
                            ...
                            echo "         <div class='col-lg-4 col-md-6'>";
                            echo "             <div class='single-project mb-30'>";
                            echo "                <p>This is the total expense of all the resources ordered in the past 30 days. For More Detail report.</p>";
                            ...
                            echo "      <div class='col-lg-4 col-md-6'>";
                            echo "          <div class='single-project mb-30'>";
                            echo "                <p>This is the total expense of all the accidents for the past 30 days. For More Detail report.</p>";
