                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="section-tittle section-tittle3">
                                <div class="front-text">
                                    <h2 class="">Accidents Summary</h2>
                                </div>
                                <div class="col-xl-2 col-lg-2 col-md-3" id = "newProjectBtn">
                                <div class="header-right-btn f-right d-none d-lg-block">
                                    <a href="accidentalHistory.php" class="btn">New Accident</a>
                                </div>
                            </div>
                            </div>
                                                ...
                                                if(!$db){
                                                    die("Connection failed: ".mysqli_connect_error());
                                                       ...
                                                       echo "</script>";
                                                               ...
                                                               if($time=="Daily"){
                                                                   $res = mysqli_query($db,"SELECT * FROM `accidents` where `date`= CURRENT_DATE AND `projectName`='$projectName';");
                                                               }
                                                               elseif($time=="Weekly"){
                                                                   $res = mysqli_query($db,"SELECT * FROM `accidents` where `date` >= CURRENT_DATE- INTERVAL 7 DAY AND `projectName`='$projectName';");
                                                               }
                                                               elseif($time=="Monthly"){
                                                                   $res = mysqli_query($db,"SELECT * FROM `accidents` where `date` >= CURRENT_DATE- INTERVAL 30 DAY AND `projectName`='$projectName';");
                                                               }
                                                               elseif($time == "NULL"){
                                                                 $res = mysqli_query($db,"SELECT * FROM `accidents` where `projectName`='$projectName';");
                                                               }
                                                               ...
                                                               echo "<h2 > ACCIDENTS DETAIL </h2>";
                                                               echo"<table class='redTable'>";
                                                               echo"<thead>";
                                                               echo"<tr>";
                                                               echo"<th>accident</th>";
                                                               echo"<th>Project Name</th>";
                                                               echo"<th>Time Delay</th>";
                                                               echo"<th>Budget Wasted</th>";
                                                               echo"<th>Date</th>";
                                                               echo"</tr>";
                                                               echo"</thead>";
                                                               ...
                                                               while ($row = mysqli_fetch_assoc($res)){
                                                                   echo "<tr >";
                                                                   echo"<td>";echo$row['accident'];echo"</td>";
                                                                   echo"<td>";echo$row['projectName'];echo"</td>";
                                                                   echo"<td>";echo$row['timeDelay'];echo"</td>";
                                                                   echo"<td>";echo$row['budgetWasted'];echo"</td>";
