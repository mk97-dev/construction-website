...
$res = mysqli_query($db,"SELECT * FROM `projects` WHERE `projectName` = '$projectName';");
...
$row = mysqli_fetch_assoc($res);
    ...
    echo"</tr>";
    echo "<tr>";
    echo"<td>";echo"<h2> Location</h2>";echo"</td>";
    echo"<td><span class='names'>";echo$row['location'];echo"</span></td>";
    echo"</tr>";
    echo "<tr>";
    ...
    echo"</tr>";
    echo "<tr>";
    echo"<td>";echo"<h2> Duration (Months)</h2>";echo"</td>";
    echo"<td><span class='names'>";echo$row['duration'];echo"</span></td>";
    echo"</tr>";
...
echo "<div class='col-xl-2 col-lg-2 col-md-3' id = 'completeProjectBtn'>";
