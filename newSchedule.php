...
?>
    ...
    <div class="row">
      ...
      <div class="col-75">
        <input type="text" id="fname" name="workName" placeholder="work Name..." required>
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="date" id="lname" name="startDate"  required>
      </div>
    </div>
    <div class="row">
      <div class="col-25">
      ...
      <div class="col-75">
        <input type="date" id="lname" name="endDate" required>
      </div>
...
<?php
			...
			if(isset($_POST['submit']))
			{
                ...
                $status = false;
                    ...
                    $sql="INSERT INTO schedule (projectId,projectName,workName,startDate,endDate,priority,status) 
                    VALUES 
                    ('$projectId','$projectName','$workName','$startDate','$endDate','$priority','$status')";
