                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="section-tittle section-tittle3">
                                <div class="front-text">
                                    <h2 class="">Resources Cost Summary</h2>
                                </div>
...
if($duration == "Monthly"){
$res = mysqli_query($db,"SELECT * FROM `resourcesdaily` WHERE `projectName` = '$projectName' AND   `Date` >= CURRENT_DATE- INTERVAL 30 DAY;");
}
elseif($duration == "Weekly"){
    $res = mysqli_query($db,"SELECT * FROM `resourcesdaily` WHERE `projectName` = '$projectName' AND   `Date` >= CURRENT_DATE- INTERVAL 7 DAY;");
    }
    elseif($duration == "Daily"){
        $res = mysqli_query($db,"SELECT * FROM `resourcesdaily` WHERE `projectName` = '$projectName' AND   `Date` = CURRENT_DATE;");
        }
        elseif($duration == "ALL"){
...
echo "<h2 >".$duration." RESOURCES REPORT </h2>";
