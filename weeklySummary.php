                    ...
                    <div class="container-fluid">
                        <div class="row align-items-center">
                            ...
                            <div class="col-xl-2 col-lg-2 col-md-1">
                                <div class="logo">
                                    <!-- logo-1 -->
                                    <a href="index.html" class="big-logo"><img src="assets/logo.png" alt=""></a>
                                    <!-- logo-2 -->
...
if(isset($_POST['submit'])){
    ...
    $duration = "Weekly";
    $laborDuesQuery = mysqli_query($db,"SELECT * FROM `dailyreport` WHERE projectName = '$projectName' AND `Date`  >= CURRENT_DATE- INTERVAL 7 DAY;");
 ...
 $resourcesCostQuery = mysqli_query($db,"SELECT * FROM `resourcesdaily` WHERE projectName = '$projectName' AND `date` >= CURRENT_DATE- INTERVAL 7 DAY;");
 ...
 $AccidentsCostQuery = mysqli_query($db,"SELECT * FROM `accidents` WHERE projectName = '$projectName' AND `date` >= CURRENT_DATE- INTERVAL 7 DAY");
    ...
    $totalAccidentCost = $totalAccidentCost + $accidentCost;
                ...
                echo " <div class='col-12'>";
                        ...
                        echo " <div class='tab-content active' id='nav-tabContent'>";
                            ...
                            echo "                <p>This is the total expense of all the labor work for the past 7 days. For More Detail report.</p>";
                            ...
                            echo "         <div class='col-lg-4 col-md-6'>";
                            echo "             <div class='single-project mb-30'>";
                            echo "                <p>This is the total expense of all the resources ordered in the past 7 days. For More Detail report.</p>";
                            ...
                            echo "      <div class='col-lg-4 col-md-6'>";
                            echo "          <div class='single-project mb-30'>";
                            echo "                <p>This is the total expense of all the accidents for the past 7 days. For More Detail report.</p>";
