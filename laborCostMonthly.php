...
function downloadPdf() {
  $(".downloadbtn").hide();
    ...
    html2canvas($(".downloadableDiv")[0]).then(function (canvas) {
        ...
        pdf.save("LaborMonthlyReport.pdf");
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="section-tittle section-tittle3">
                                <div class="front-text">
                                    <h2 class="">LABOR COST Summary</h2>
                                </div>
...
if($duration == "Monthly"){
$res = mysqli_query($db,"SELECT * FROM `dailyreport` WHERE `projectName` = '$projectName' AND   `Date` >= CURRENT_DATE- INTERVAL 30 DAY;");
}
elseif($duration == "Weekly"){
    $res = mysqli_query($db,"SELECT * FROM `dailyreport` WHERE `projectName` = '$projectName' AND   `Date` >= CURRENT_DATE- INTERVAL 7 DAY;");
    }
    elseif($duration == "Daily"){
        $res = mysqli_query($db,"SELECT * FROM `dailyreport` WHERE `projectName` = '$projectName' AND   `Date` = CURRENT_DATE;");
        }
        elseif($duration == "ALL"){
        $res = mysqli_query($db,"SELECT * FROM `dailyreport` WHERE `projectName` = '$projectName';");
        }
...
echo "<h2 >".$duration." LABOR REPORT </h2>";
...
while ($row = mysqli_fetch_assoc($res)){
    echo "<tr onclick='showDetail(\"showAttendantDetail.php?attendantName=".$row['Attendant']."&duration=".$duration."\");'>";
