        ...
        <section class="project-area  section-padding30">
            <div class="container">
               <div class="project-heading mb-35">
                   ...
                   <div class="col-75">
                     <select id="projectName" name="clientName" required>
...
echo "<script type='text/javascript'>"; 
 echo "document.getElementById('projectName').value ='$clientName'";
 echo "</script>";
...
$row = mysqli_fetch_assoc($res);
    echo "<tr>";
    echo"<td>";echo"<h2> CLIENT ID</h2>";echo"</td>";
    echo"<td><span class='names'>";echo$row['clientId'];echo"</span></td>";
    echo"</tr>";
    echo "<tr>";
    echo"<td>";echo"<h2> Client Name </h2>";echo"</td>";
    echo"<td><span class='names'>";echo$row['clientName'];echo"</span></td>";
    echo"</tr>";
    echo "<tr>";
    echo"<td>";echo"<h2> Phone No</h2>";echo"</td>";
    echo"<td><span class='names'>";echo$row['phoneNo'];echo"</span></td>";
    echo"</tr>";
    echo "<tr>";
    echo"<td>";echo"<h2> Email </h2>";echo"</td>";
    echo"<td><span class='names'>";echo$row['email'];echo"</span></td>";
    echo"</tr>";
    echo "<tr>";
    echo"<td>";echo"<h2> PROJECTS</h2>";echo"</td>";
    echo"<td><span class='names'>";echo"<a href=\"projectsByClient.php?clientName=".$row['clientName']."\">".'Click Here'."</a>";echo"</span></td>";
    echo"</tr>";
...
?>
            ...
            <button onclick="" id="completeProjectBtn" class = "downloadBtn"></button>
        </section>
        <!-- Services Area Start -->
